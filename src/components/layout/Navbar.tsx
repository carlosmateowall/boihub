...
export function Navbar({ title }: NavbarProps) {
  return (
    <header className="lg:hidden bg-canvas sticky top-0 z-40 flex items-center justify-between px-4 py-4 border-b border-canvas-soft">
      ...
      <button className="relative p-2 rounded-xl hover:bg-canvas-soft transition-colors">
